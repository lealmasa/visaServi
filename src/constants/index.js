...
export const serviciosVisa = [
  ...
  },
  {
    ...
    paises: [
      ...
      {
        subtitle: "Requisitos de visa de estudios México",
        requisitos: [
          "Formato L1 debidamente completado",
          "Pasaporte con una vigencia mínima de seis (6) meses de la fecha prevista de ingreso.",
          " Original y copia de prueba de residencia legal permanente o temporal (visa y permiso de trabajo) en Trinidad y Tobago, Barbados o Surinam.",
          " Carta de Aceptación de una institución educativa mexicana",
          " Comprobación de solvencia económica para pagar los gastos de inscripción, vivienda y alimentación durante la estancia del solicitante en México",
        ],
      },
      {
        subtitle: "Requisitos de visa de trabajo México",
        requisitos: [
          "Tener una oferta laboral de un empleador mexicano.",
          "El empleador en México debe realizar la petición ante el Instituto Nacional de Migración.",
          "Para tramitar la autorización, primero es necesario que el empleador cuente “Constancia de Inscripción de empleados”.",
          "Posteriormente debe iniciar el trámite de “Visa de residencia temporal, de visitante con permiso para realizar actividades remuneradas.",
          "Si la resolución es favorable se le entregara al empleador un oficio de autorización del visado",
          "Completar la solicitud de visa de forma legible",
          "Copia del oficio de autorización por parte de Migración",
