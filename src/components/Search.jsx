...
const Search = () => {
  return (
    <div className=' z-10 bg-bgPrimary py-10 px-8 sm:px-12 sm:absolute mt-4 bottom-[32px] left-0 right-0 mx-auto max-w-[720px] rounded-lg sm:shadow-2xl flex flex-col sm:flex-row justify-between gap-y-8 sm:gap-y-0'>
